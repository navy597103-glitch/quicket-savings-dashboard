  ...
  return (
    <Field label={label} suffix={suffix}>
      <input
        ...
        className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-50"
      />
    </Field>
  )
}
...
function KpiCard({ kpi, active, onClick }) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`group relative min-h-[156px] rounded-3xl border bg-white p-5 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md ${
    ...
    >
      ...
      <div
        className={`mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full transition ${
      ...
      <div className="mt-2 text-center text-2xl font-bold tracking-tight text-blue-900">{kpi.value}</div>
...
function KpiExplanation({ activeKpi, result, form }) {
  ...
  return (
    <section className="rounded-3xl border border-blue-100 bg-white p-5 shadow-sm">
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_1fr_1.7fr]">
...
export default function App() {
  const [form, setForm] = useState(presets['工業天井燈'])
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <div className="mx-auto max-w-[1480px] px-4 py-5 lg:px-8">
        ...
        <main className="grid gap-5 lg:grid-cols-[320px_1fr] xl:grid-cols-[340px_1fr]">
          <aside className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="space-y-4">
              <SelectField label="場域類型" value={form.siteType} onChange={(value) => set('siteType', value)} options={siteOptions} />
              <SelectField label="燈具類型" value={form.luminaireType} onChange={(value) => set('luminaireType', value)} options={luminaireOptions} />
              <NumberField label="燈具數量" suffix="盞" value={form.quantity} onChange={(value) => set('quantity', value)} />
              <NumberField label="計算年限" suffix="年" value={form.years} onChange={(value) => set('years', value)} />
              ...
              <div className="grid grid-cols-2 gap-3">
                <NumberField label="每日使用" suffix="小時" value={form.dailyHours} onChange={(value) => set('dailyHours', value)} />
                <NumberField label="每年使用" suffix="天" value={form.annualDays} onChange={(value) => set('annualDays', value)} />
              </div>
              ...
              <div className="rounded-2xl border border-blue-100 bg-blue-50/40">
                ...
                {advancedOpen && (
                  <div className="space-y-4 border-t border-blue-100 px-4 py-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <NumberField label="現有維護週期" suffix="年" value={form.currentMaintenanceCycle} onChange={(value) => set('currentMaintenanceCycle', value)} />
                      <NumberField label="QUICKET 維護週期" suffix="年" value={form.quicketMaintenanceCycle} onChange={(value) => set('quicketMaintenanceCycle', value)} />
                    </div>
          ...
          <section className="space-y-5">
            ...
            <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
              <div className="grid grid-cols-2 border-b border-slate-200 bg-white md:grid-cols-5">
